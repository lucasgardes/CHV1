...
export const EVENTS = Object.freeze([
  {
    ...
    choices:[
      { id:"leave-closed", label:"Quitter la salle sans ouvrir le coffre", effect:{ type:"gain-gold", amount:25 } },
      {
        ...
        effect:{ type:"compound", effects:[{ type:"gain-gold", amountRange:[35,45] }, { type:"shop-price-multiplier", multiplier:1.05 }] }
      }
    ]
  },
  {
  ...
  {
    id:"calculated-sacrifice",
    category:"immediate-choice",
    difficulty:"medium",
    title:"Le sacrifice calculé",
    ...
    choices:[
      ...
      {
        id:"sacrifice-consumable",
        label:"Sacrifier un consommable",
        effect:{
          type:"choose-owned-item",
          itemType:"consumable",
          selectionTitle:"Sacrifier un consommable",
          prompt:"Choisis le consommable qui sera détruit.",
          unavailableLabel:"Tu ne possèdes aucun consommable.",
          selectedEffect:{ type:"lose-item", itemId:"$selectedItemId" }
        }
      },
      {
        id:"accept-sanction",
        label:"Accepter la sanction",
        effect:{ type:"compound", effects:[
          { type:"next-intensity", amount:1, encounters:1, source:"calculated-sacrifice" },
          { type:"next-reward", multiplier:1.25, source:"calculated-sacrifice" }
        ] }
      }
    ]
  },
  {
    ...
    category:"immediate-choice",
    difficulty:"medium",
    title:"Le dilemme du repos",
    description:"Le protocole peut être ralenti, mais le temps gagné doit être compensé d’une autre manière.",
    choices:[
      {
        id:"take-break",
        label:"Prendre une pause de 45 secondes et recharger un objet",
        effect:{
          type:"choose-owned-item",
          itemType:"rechargeable",
          selectionTitle:"Choisir l’objet à recharger",
          prompt:"Sélectionne l’objet rechargeable qui profitera de la pause.",
          unavailableLabel:"Tu ne possèdes aucun objet rechargeable.",
          selectedEffect:{ type:"recharge-item", itemId:"$selectedItemId" },
          afterEffects:[{ type:"next-reward", goldFlat:-20, source:"rest-dilemma" }]
        }
      },
      { id:"continue", label:"Continuer immédiatement — gagner 30 pièces d’or", effect:{ type:"gain-gold", amount:30 } },
      {
        id:"accelerate",
        label:"Accélérer le protocole",
        effect:{ type:"compound", effects:[
          { type:"next-duration", seconds:-20, source:"rest-dilemma" },
          { type:"next-intensity", amount:1, encounters:1, source:"rest-dilemma" }
        ] }
      }
    ]
  },
  {
    ...
    choices:[
      ...
      {
        id:"use-equipment",
        label:"Utiliser son équipement",
        effect:{
          type:"choose-owned-item",
          itemType:"rechargeable",
          selectionTitle:"Désactiver un objet rechargeable",
          prompt:"Choisis l’objet qui sera désactivé jusqu’à ce que deux rencontres soient réussies.",
          unavailableLabel:"Tu ne possèdes aucun objet rechargeable.",
          selectedEffect:{ type:"disable-item", itemId:"$selectedItemId", encounters:2 }
        }
      },
  ...
  },
  {
    ...
    choices:[
      { id:"wait", label:"Attendre le redémarrage — recevoir 20 pièces d’or", effect:{ type:"gain-gold", amount:20 } },
      {
        ...
        effect:{ type:"random-outcome", outcomes:[{ type:"gain-gold", amount:40 }, { type:"hide-interface", seconds:15, source:"lighting-failure" }] }
      }
    ]
  }
]);
