...
import { BLESSING_RARITIES,INITIAL_BLESSING_IDS,getBlessingById } from "../data/blessings.js";
...
export class BlessingService{
 ...
 applyStartEffect(blessing=this.getActive()){if(!blessing)return null;switch(blessing.effect.type){case"starting-gold-and-free-reroll":this.gameState.gold+=blessing.effect.gold;this.gameState.setRunFlag("blessing-free-first-reroll",true);break;case"reveal-branch-encounters":this.gameState.setRunFlag("reveal-branch-encounters",true);break;case"lower-normal-difficulty":this.gameState.setRunFlag("lower-normal-difficulty",true);break;}return blessing;}
