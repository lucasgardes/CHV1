...
export class ItemController {
  ...
  isAvailable(itemId) {
    if (!this.hasItem(itemId) || this.gameState.isItemDisabled?.(itemId)) return false;
  ...
  getState(itemId) { return { ...this.ensureRuntimeState(itemId), disabled: this.gameState.isItemDisabled?.(itemId) === true }; }
}