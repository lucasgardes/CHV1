...
export class GameState{
 ...
 reset(){this.status=GAME_STATUS.MENU;this.gold=50;this.inventory=[];this.upgradedItemIds=[];this.activeBlessingId=null;this.totalGoldEarned=0;this.totalGoldSpent=0;this.totalGoldLost=0;this.elitesDefeated=0;this.consumedDefeatProtectionIds=[];this.currentNodeId=null;this.completedNodeIds=[];this.currentEncounter=null;this.nextFunscriptDifficultyShift=0;this.nextEncounterProtectionArmed=false;this.seenEventIds=[];this.pendingEncounterModifiers=[];this.disabledItems={};this.cobayeRelations={};this.eventFlags={};this.runFlags={};this.nextShopPriceMultiplier=1;this.nextEliteRareChanceBonus=0;this.campfiresEncountered=0;this.campfireNarrativeNodeIds=[];this.campfireNodeIdsSeen=[];this.itemRunState=createItemRunState();}
